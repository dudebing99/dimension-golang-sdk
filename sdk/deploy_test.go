...
import (
	...
	"github.com/dudebing99/dimension-golang-sdk/keypair"
	"github.com/dudebing99/dimension-golang-sdk/keypair/ed25519"
	"github.com/dudebing99/dimension-golang-sdk/types"
...
// tests for deploy with hash 48b33972cdc075d82363279640490b64bcac26cd540c8cf16da688d400c86b66 on dimension testnet
func TestDeployUtil_HashDeployHeaderCorrectly(t *testing.T) {
	...
	deployHeader := NewDeployHeader(keypair.PublicKey{
		...
		Tag:        1,
	}, parse.UnixNano()/1000000, (30 * time.Minute).Milliseconds(), 1, bodyHash, nil, "dimension-test")
...
func TestDeployUtil_HashBodyAndMarshalJSONCorrectly(t *testing.T) {
	...
	deploy := MakeDeploy(NewDeployParams(keypair.PublicKey{PubKeyData: target, Tag: keypair.KeyTagEd25519}, "dimension-test", nil, int64(timeParsed.UnixNano())/1000000), payment, session)
	...
	assert.Equal(t,
		"{\"hash\":\"48b33972cdc075d82363279640490b64bcac26cd540c8cf16da688d400c86b66\",\"header\":{\"account\":\"01d995c93ac47e763433b5ec973cac464c7343d76d6bd47c936cf8ce5d83032061\",\"timestamp\":\"2021-09-13T17:51:59.181Z\",\"ttl\":\"30m0s\",\"gas_price\":1,\"body_hash\":\"f9608668e24e68cad0c930016e1885d1d82fdb655b254130c32b586c4443af37\",\"dependencies\":[],\"chain_name\":\"dimension-test\"},\"payment\":{\"ModuleBytes\":{\"args\":[[\"amount\",{\"bytes\":\"021027\",\"cl_type\":\"U512\"}]],\"module_bytes\":\"\"}},\"session\":{\"Transfer\":{\"args\":[[\"amount\",{\"bytes\":\"0400f90295\",\"cl_type\":\"U512\"}],[\"target\",{\"bytes\":\"a6d3d9fb1044cf5db1b30ad3f8f2c2c69e48ae69ab8aae6f02d69b0d0faa9e3d\",\"cl_type\":{\"ByteArray\":32}}],[\"id\",{\"bytes\":\"010100000000000000\",\"cl_type\":{\"Option\":\"U64\"}}]]}},\"approvals\":[]}",
		string(marshal))
}
...
func TestDeployUtil_UnmarshalJSONCorrectly(t *testing.T) {
	...
	assert.Equal(t, "dimension-test", deployResult.Header.ChainName)
...
func TestDeployUtil_IsDeploy(t *testing.T) {
	deploy := NewTransferToUniqAddress(*source, UniqAddress{
		PublicKey:  dest,
		TransferId: 10,
	}, big.NewInt(3), big.NewInt(1), "dimension-test", "")
