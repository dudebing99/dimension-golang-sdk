...
func Secp256k1Random() keypair.KeyPair {
	...
	return &secp256k1KeyPair{publicKey: pub, privateKey: priv}
}
...
// privateKey returns Secp256k1 private key
func (key *secp256k1KeyPair) PrivateKey() string {
...
func ParseKeyPair(publicKey, privateKey string) keypair.KeyPair {
	...
	keyPair := secp256k1KeyPair{publicKey: pub, privateKey: priv}
